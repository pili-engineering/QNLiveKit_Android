...
class QAnchorHostMicLinkerImpl(private val context: MicLinkContext) : QNAnchorHostMicLinker,
    BaseService() {
    ...
    private val mMicLinkerListener = object : QLinkMicService.MicLinkerListener {
        ...
        override fun onUserExtension(micLinker: QNMicLinker, extension: QExtension) {}
    }
