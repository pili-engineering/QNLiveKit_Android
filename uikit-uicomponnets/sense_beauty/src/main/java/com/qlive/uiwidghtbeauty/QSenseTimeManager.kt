...
import com.softsugar.library.api.Material.init
import com.softsugar.library.api.Material.updateTokenSync
import com.softsugar.library.sdk.utils.ContextHolder
import sensetime.senseme.com.effects.SenseMeApplication
import sensetime.senseme.com.effects.utils.PropertiesUtil.getBooleanValue
import sensetime.senseme.com.effects.utils.Constants
import sensetime.senseme.com.effects.utils.SpUtils
import sensetime.senseme.com.effects.utils.ThreadUtils
...
object QSenseTimeManager {
    ...
    fun initEffectFromLocalLicense(appContext: Context, isFromQLive: Boolean) {
        ...
        SenseMeApplication.mContext = appContext
        ContextHolder.initial(appContext)
        ThreadUtils.getInstance().initThreadPool()
        SpUtils.init(appContext)
        init(appContext, Constants.APP_ID, Constants.APP_KEY)
        updateTokenSync()
        SenseArMaterialService.shareInstance().initialize(appContext)
