...
public class MicLinkerSplitScreenPreview extends QKitFrameLayout {
    ...
    @Override
    public void onJoined(@NonNull QLiveRoomInfo roomInfo) {
        super.onJoined(roomInfo);
        linkerPreview.onJoined(roomInfo);
    }
    ...
    static class AnchorMicLinkerSplitScreenPreview extends BaseSplitScreenPreview {
        ...
        private final QAnchorHostMicHandler.QMixStreamAdapter mixStreamAdapter = new QAnchorHostMicHandler.QMixStreamAdapter() {
            ...
            public QMixStreamParams onMixStreamStart() {
                ...
                params.setMixBitrate(1500 * 1000);
                params.setFPS(25);
                return params;
            }
            ...
            public List<QMergeOption> onResetMixParam(List<QMicLinker> list, QMicLinker qMicLinker, boolean b) {
                ...
                anchorCameraMergeOption.setX(0);
                ...
                anchor.setMicrophoneMergeOption(anchorMicrophoneMergeOption);
                ...
                playerCameraMergeOption.setX(720 / 2);
